...
$prod=$utic->afficherutilisateurcat("Admin");
$tec=$utic->afficherutilisateurcat("Formateur");
$part=$utic->afficherutilisateurcat("participent");
...
?>
                    ...
                    <li class="menu-item-has-children dropdown">
                      ...
                      <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="table-formation.php">Formation</a></li>
                                            <li><i class="fa fa-table"></i><a href="table-participent.php">Participent</a></li>
                                             <li><i class="fa fa-table"></i><a href=" table-favorie.php">Participent</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                  ...
                                  <a href="table-utilisateur.php.php"></a>
                        <form method="post" action="rechutili.php">  
...
<input type="hidden" value="<?php echo $pro['id_utilisateur'] ?>" name="id_utilisateur">
                            ...
                            <div class="card-header">
                                <strong class="card-title">Formateur</strong>
                            </div>
...
<input type="hidden" value="<?php echo $rec['id_utilisateur'] ?>" name="id_utilisateur">
                                        ...
                                        <?php  } ?>
                                                      ...
                                                      <table  class="table table-striped table-bordered">
                                                          <strong class="card-title">Participent</strong>
                                    <thead>
                                        <tr>
                                            <th>Id_utilisateur</th>
                                            <th>Nom</th>
...
?>
                                            ...
                                            <td> <?php echo $zec['id_utilisateur'] ?> </td>
                                            <td><?php echo $zec['nom'] ?></td>
                                            <td><?php echo $zec['prenom'] ?></td>
                                            <td><?php echo $zec['adresse'] ?></td>
                                            <td><?php echo $zec['mdp'] ?></td>
                                             <td><?php echo $zec['role'] ?></td>
                                   ...
                                   <td>     <form method="post" action="supprumerutilisateur.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $zec['id_utilisateur'] ?>" name="id_utilisateur">
</form></td>
<td> 
<form method="GET" action="Modifierutilisateur.php" >
<input type="submit" value="Modifier"class="btn btn-primary btn-lg" >
