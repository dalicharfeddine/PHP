...
$prod=$formation->afficherformations();
        ...
        <div class="content mt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                          <a href="triprix.php">Tri par prix</a>
         ...
         <button type="submit" name="Ajouter" value="Ajouter" class="btn btn-danger">Recherche </button>
           ...
           <form method="POST" action="stat.php">
                     ...
                     <button type="submit"  id="statistique"  class="btn btn-info" href="newstat.php"> statistique</button>
...
?>
                                            ...
                                            <td> <?php echo $pro['Nom'] ?> </td>
                                              <td> <?php echo $pro['dat'] ?> </td>
                                            <td><?php echo $pro['prix'] ?>dt</td>
                                            <td><?php echo $pro['nbr_place'] ?></td>
                                            <td><?php echo $pro['duree'] ?> mois</td>
      ...
      <style>
            ...
            width: 90px;
             ...
             <td><?php echo $pro['emplacement'] ?></td>
                            <td><?php echo $pro['description'] ?></td>
                                            <td><?php echo $pro['positive'] ?></td>
                            <td><?php echo $pro['negative'] ?></td>

                                   <td>     <form method="post" action="table-formation.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_formation'] ?>" name="id_formation">
</form></td>
<td>
...
<button class="btn btn-primary" onclick="print('table-formation.php')">Imprimer le PDF</button>
