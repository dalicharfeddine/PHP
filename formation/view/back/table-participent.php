...
$formation=new participentC();
$prod=$formation->afficherparticipent();
$for=new formationC();
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="parti.php">  
         
 
         <button type="submit" name="Ajouter" value="Ajouter" class="btn btn-danger">Nom participent </button>
       </form>
...
?> 
                                            ...
                                            <td> <?php echo $pro['id_utilisateur'] ?> </td>
                                              <td> <?php echo $pro['id_formateur']?> </td>
                                                    
                           
                                            
        
                                   <td>     <form method="post" action="supprumerpar.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_participent'] ?>" name="id_participent">
</form></td>
