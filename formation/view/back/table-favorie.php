...
$prod=$formation->afficherfavorie();
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Favorie</strong>
                            </div>
                            <div class="card-body">
...
?>
                                            ...
                                            <td> <?php echo $pro['id_utilisateur'] ?> </td>
                                              <td> <?php echo $pro['id_formation'] ?> </td>
                                                    
                           
                                            
        
                                   <td>     <form method="post" action="supprumerfav.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_favorie'] ?>" name="id_favorie">
</form></td>
