...
?>
                                            ...
                                            <td><?php echo $pro['theme'] ?></td>
                                            
                        
                           
                                            
        
                                   <td>     <form method="post" action="supprumertype.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_type'] ?>" name="id_type">
</form></td>
<td> 
<form method="GET" action="modifiertype.php" >
...
<input type="hidden" value="<?php echo $pro['id_type'] ?>" name="id_type">
     ...
     <div>
            <button type="button" class="btn btn-primary btn-lg"  style="margin-top:3%;margin-left:5%;border-radius: 5%;">
                <a href="Ajoutertype.php">Ajouter Type</a>
