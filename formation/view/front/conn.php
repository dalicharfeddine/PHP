    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 align-self-center">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="contact" action="testcnxfront.php" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h2>Cree Compte</h2>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <fieldset>
                                            <li><a href="index.PHP">Connecte</a></li>
                                            <a href="compte.php">Créer un compte</a><br>
                                            <a href="mspoub.php">mot de passe oublié</a>
                                        </fieldset>
                                    </div>
                                </div>
                        </form>
                                ...
                                <div class="col-lg-12">
                                    <form id="contact" action="" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <fieldset>
                                                    <button type="submit" id="form-submit" class="button">SEND fff NOW</button>
                                                </fieldset>
                                            </div>
                                        </div>
                                    </form>
