    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 align-self-center">
          <div class="row">
            <div class="col-lg-12">
              <form id="contact" action="fctmdpoublier.php" method="post">
                <div class="row">
                  <div class="col-lg-12">
                    <h2>Cree Compte</h2>
                  ...
                  <div class="col-lg-4">
                   ...
                   <div class="col-lg-12">
                    <fieldset>
                        <a href="mspoub.php">Envoyer lien</a>
...
if($_SESSION['email']==1)
{
 ...
 '<script>
          document.getElementById("msg").innerHTML="Chec your mail ";
              </script>'
...
else if($_SESSION['email']==2)
{
 ...
 '<script>
          document.getElementById("msg").innerHTML="Mail existant ";
              </script>'
